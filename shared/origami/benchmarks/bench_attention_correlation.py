#!/usr/bin/env python3
"""
GPU-Based Origami Attention Correlation Benchmark
=====================================================
...
Measures correlation (Spearman rho, Pearson r) between predicted and actual
latencies across tile configs, and reports tile selection regret.
...
def main():
    ...
    parser.add_argument("--output-dir", default="/tmp/attn_corr",
